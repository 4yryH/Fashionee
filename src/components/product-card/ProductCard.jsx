  ...
  return (
    <article className={'product-card'}>
      <div className={'product-card__image-wrapper'}>
        ...
        <span
          className={
            badgeSaleProps.className ||
            'product-card__badge product-card__badge--sale'
          }
        >
          {badgeSaleProps.content || 'Sale'}
        </span>
        <span
          className={
            badgeNewProps.className ||
            'product-card__badge product-card__badge--new'
          }
        >
          {badgeNewProps.content || 'New'}
        </span>
        <button
          type="button"
      ...
      <div className={'product-card__caption-wrapper'}>
        <h3 className={'product-card__title'}>
          {titleProps.content || 'Title Product'}
        </h3>
        <div className={'product-card__prices'}>
          <p className={priceProps.className || 'product-card__price'}>
